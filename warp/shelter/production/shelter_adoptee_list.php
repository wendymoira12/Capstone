          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile clearfix">
              ...
              <div class="profile_pic">
                <img src="/Capstone/warp/WARP Admin/production/images/<?= $data['city_img']; ?>" alt="..." class="img-circle profile_img">
              </div>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="/Capstone/warp/WARP Admin/production/images/<?= $data['city_img']; ?>" alt=""><?= $_SESSION['user-email'] ?>
                    ...
                    ?>
                        <li>
                          <a>
                            ...
                            <span>
                              <span><?= $notif['adopter_fname'] . ' ' . $notif['adopter_lname']; ?></span>
                              <span class="time">3 mins ago</span>
                            </span>
                            <span class="message">
                              <?= $notif['message'] . ' ' . $notif['pet_name']; ?>
                            </span>
                          </a>
                        </li>
                    <?php
