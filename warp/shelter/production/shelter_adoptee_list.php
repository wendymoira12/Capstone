...
?>
  ...
  <head>
    ...
    <title><?php echo $row['city_name']; ?> | Adoptee Pet List</title>
                ...
                <table id="datatable" class="table table-striped table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          <td><?= $i++; ?></td>
                          <td><?= '<img src="images/pet_img1/' . $row['pet_img1'] . '" alt="pet" width="100px" height="100px";>'; ?></td>
                          <td><?= '<img src="images/pet_img2/' . $row['pet_img2'] . '" alt="pet" width="100px" height="100px";>'; ?></td>
                          <td><?= $row['pet_name']; ?></td>
                          <td><?= $row['pet_age']; ?></td>
                          <td><?= $row['pet_color']; ?></td>
                          <td><?= $row['pet_breed']; ?></td>
