...
<head>
  ...
  <title><?php echo $row2['city_name']; ?> | View Adopter Account</title>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                if ($rows['application_status'] == "Finished") {
                                  ...
                                  $sql3 = "SELECT monitoring_status FROM adopted_tbl WHERE application_id = '$app_id'";
                              ...
                              <td>
                                ...
                                if ($rows['application_status'] == "Finished") {
                                  $app_id = $rows['application_id'];
                                  $sql3 = "SELECT adopted_id, monitoring_status FROM adopted_tbl WHERE application_id = '$app_id'";
                                  $result2 = mysqli_query($conn, $sql3);
                                  if ($result2->num_rows > 0) {
                                    $rows2 = mysqli_fetch_assoc($result2);
